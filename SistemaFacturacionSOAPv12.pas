...
// Version  : 1.0
// (03/04/2024 11:02:03 - - $Rev: 112483 $)
// ************************************************************************ //

unit SistemaFacturacionSOAPv12;
...
type
  ...
  SistemaFacturacionFact = class;               { "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd"[GblCplx] }
  ...
  Cabecera             = class;                 { "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd"[GblCplx] }
  ...
  private
    FRegistroAlta: RegistroFacturacionAltaType;
    FRegistroAlta_Specified: boolean;
    FRegistroAnulacion: RegistroFacturacionAnulacionType;
    FRegistroAnulacion_Specified: boolean;
    procedure SetRegistroAlta(Index: Integer; const ARegistroFacturacionAltaType: RegistroFacturacionAltaType);
    function  RegistroAlta_Specified(Index: Integer): boolean;
    procedure SetRegistroAnulacion(Index: Integer; const ARegistroFacturacionAnulacionType: RegistroFacturacionAnulacionType);
    function  RegistroAnulacion_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property RegistroAlta:      RegistroFacturacionAltaType       Index (IS_OPTN) read FRegistroAlta write SetRegistroAlta stored RegistroAlta_Specified;
    property RegistroAnulacion: RegistroFacturacionAnulacionType  Index (IS_OPTN) read FRegistroAnulacion write SetRegistroAnulacion stored RegistroAnulacion_Specified;
  end;
  ...
  Numerico4Type   = string;         { "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd"[GblSmpl] }
  ...
  tRespuestaLinea= class(TRemotable)
       private
            _DescripcionErrorRegistro,_CodigoErrorRegistro:string;
            _CSVRegistroDuplicado:string;
            _EstadoRegistroDuplicado:EstadoRegistroSFType;

            _IDFactura      :IDFacturaExpedidaType;
            _EstadoRegistro :EstadoRegistroType;
       published
           property IDFactura:IDFacturaExpedidaType   read _IDFactura                 write _IDFactura;
           property EstadoRegistro:EstadoRegistroType read _EstadoRegistro            write _EstadoRegistro;
           property CodigoErrorRegistro:string        read  _CodigoErrorRegistro      write _CodigoErrorRegistro;
           property DescripcionErrorRegistro:string   read _DescripcionErrorRegistro  write _DescripcionErrorRegistro;
           property CSVRegistroDuplicado:string       read _CSVRegistroDuplicado      write _CSVRegistroDuplicado;

           property EstadoRegistroDuplicado:EstadoRegistroSFType  read _EstadoRegistroDuplicado write _EstadoRegistroDuplicado;
  end;

  Array_Of_RespuestaLinea= array of tRespuestaLinea;

  RespuestaBaseType = class(TRemotable)
  private
    _RespuestaLinea:Array_Of_RespuestaLinea;
  ...
  published
    ...
    property Cabecera:          Cabecera               read FCabecera write FCabecera;
    ...
    property RespuestaLinea: Array_Of_RespuestaLinea read _RespuestaLinea write _RespuestaLinea;
    //
  ...
  published
    property ClaveRegimen:                  IdOperacionesTrascendenciaTributariaType  read FClaveRegimen write FClaveRegimen;
  ...
  private
    ...
    function  Id_Specified(Index: Integer): boolean;
  published
    property Text: TByteSOAPArray  read FText write FText;
    property Id:   string          Index (IS_ATTR or IS_OPTN) read FId write SetId stored Id_Specified;
  end;
  ...
  ErrorDetalleType = Int64;         { "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/RespuestaSuministro.xsd"[GblSmpl] }
  ...
  private
    ...
    FCSVRegistroDuplicado: string;
    FCSVRegistroDuplicado_Specified: boolean;
    FEstadoRegistroDuplicado: EstadoRegistroSFType;
    FEstadoRegistroDuplicado_Specified: boolean;
    ...
    procedure SetCSVRegistroDuplicado(Index: Integer; const Astring: string);
    function  CSVRegistroDuplicado_Specified(Index: Integer): boolean;
    procedure SetEstadoRegistroDuplicado(Index: Integer; const AEstadoRegistroSFType: EstadoRegistroSFType);
    function  EstadoRegistroDuplicado_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    ...
    property CSVRegistroDuplicado:     string                 Index (IS_OPTN) read FCSVRegistroDuplicado write SetCSVRegistroDuplicado stored CSVRegistroDuplicado_Specified;
    property EstadoRegistroDuplicado:  EstadoRegistroSFType   Index (IS_OPTN) read FEstadoRegistroDuplicado write SetEstadoRegistroDuplicado stored EstadoRegistroDuplicado_Specified;
  end;

  DigestValueType = TByteSOAPArray;      { "http://www.w3.org/2000/09/xmldsig#"[GblSmpl] }
  ...
  // ************************************************************************ //
  // XML       : SistemaFacturacionFact, global, <complexType>
  // Namespace : https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd
  // ************************************************************************ //
  SistemaFacturacionFact = class(TRemotable)
  private
    FCabecera: Cabecera;
  public
    destructor Destroy; override;
  ...
  // Namespace : https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroLR.xsd
  // ************************************************************************ //
  RegFactuSistemaFacturacion = class(SistemaFacturacionFact)
  private
  ...
  CryptoBinary    = TByteSOAPArray;      { "http://www.w3.org/2000/09/xmldsig#"[GblSmpl] }
  ...
  // ************************************************************************ //
  // XML       : Cabecera, global, <complexType>
  // Namespace : https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd
  // ************************************************************************ //
  Cabecera = class(TRemotable)
  private
  ...
  private
    ...
    FNombreSistemaInformatico_Specified: boolean;
    ...
    FTipoUsoPosibleSoloVerifactu_Specified: boolean;
    FTipoUsoPosibleMultiOT: SiNoType;
    FTipoUsoPosibleMultiOT_Specified: boolean;
    FNumeroOTAlta: Numerico4Type;
    FNumeroOTAlta_Specified: boolean;
    procedure SetNIF(Index: Integer; const ANIFType: NIFType);
    function  NIF_Specified(Index: Integer): boolean;
    procedure SetIDOtro(Index: Integer; const AIDOtroType: IDOtroType);
    function  IDOtro_Specified(Index: Integer): boolean;
    procedure SetNombreSistemaInformatico(Index: Integer; const ATextMax30Type: TextMax30Type);
    function  NombreSistemaInformatico_Specified(Index: Integer): boolean;
    procedure SetTipoUsoPosibleSoloVerifactu(Index: Integer; const ASiNoType: SiNoType);
    function  TipoUsoPosibleSoloVerifactu_Specified(Index: Integer): boolean;
    procedure SetTipoUsoPosibleMultiOT(Index: Integer; const ASiNoType: SiNoType);
    function  TipoUsoPosibleMultiOT_Specified(Index: Integer): boolean;
    procedure SetNumeroOTAlta(Index: Integer; const ANumerico4Type: Numerico4Type);
    function  NumeroOTAlta_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property NombreRazon:                 TextMax120Type  read FNombreRazon write FNombreRazon;
    property NIF:                         NIFType         Index (IS_OPTN) read FNIF write SetNIF stored NIF_Specified;
    property IDOtro:                      IDOtroType      Index (IS_OPTN) read FIDOtro write SetIDOtro stored IDOtro_Specified;
    property NombreSistemaInformatico:    TextMax30Type   Index (IS_OPTN) read FNombreSistemaInformatico write SetNombreSistemaInformatico stored NombreSistemaInformatico_Specified;
    ...
    property TipoUsoPosibleSoloVerifactu: SiNoType        Index (IS_OPTN) read FTipoUsoPosibleSoloVerifactu write SetTipoUsoPosibleSoloVerifactu stored TipoUsoPosibleSoloVerifactu_Specified;
    property TipoUsoPosibleMultiOT:       SiNoType        Index (IS_OPTN) read FTipoUsoPosibleMultiOT write SetTipoUsoPosibleMultiOT stored TipoUsoPosibleMultiOT_Specified;
    property NumeroOTAlta:                Numerico4Type   Index (IS_OPTN) read FNumeroOTAlta write SetNumeroOTAlta stored NumeroOTAlta_Specified;
  end;

  Timestamp       = string;         { "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd"[GblSmpl] }
  ...
  private
    FRefRequerimiento: fecha;
    FRefRequerimiento_Specified: boolean;
    procedure SetRefRequerimiento(Index: Integer; const Afecha: fecha);
    function  RefRequerimiento_Specified(Index: Integer): boolean;
  published
    property RefRequerimiento: fecha  Index (IS_OPTN) read FRefRequerimiento write SetRefRequerimiento stored RefRequerimiento_Specified;
  end;
  ...
  private
    ...
    FIdAcuerdoSistemaInformatico: TextMax15Type;
    ...
    procedure SetIdAcuerdoSistemaInformatico(Index: Integer; const ATextMax15Type: TextMax15Type);
  ...
  published
    ...
    property IdAcuerdoSistemaInformatico:         TextMax15Type                Index (IS_OPTN) read FIdAcuerdoSistemaInformatico write SetIdAcuerdoSistemaInformatico stored IdAcuerdoSistemaInformatico_Specified;
    property TipoHuella:                          TipoHuellaType               read FTipoHuella write FTipoHuella;
    property Huella:                              TextMax64Type                read FHuella write FHuella;
    property Signature:                           Signature                    Index (IS_OPTN) read FSignature write SetSignature stored Signature_Specified;
  end;
...
procedure RegistroFacturaType.SetRegistroAlta(Index: Integer; const ARegistroFacturacionAltaType: RegistroFacturacionAltaType);
begin
  FRegistroAlta := ARegistroFacturacionAltaType;
...
procedure RegistroFacturaType.SetRegistroAnulacion(Index: Integer; const ARegistroFacturacionAnulacionType: RegistroFacturacionAnulacionType);
begin
  FRegistroAnulacion := ARegistroFacturacionAnulacionType;
...
procedure RespuestaExpedidaType.SetCSVRegistroDuplicado(Index: Integer; const Astring: string);
begin
  FCSVRegistroDuplicado := Astring;
  FCSVRegistroDuplicado_Specified := True;
end;

function RespuestaExpedidaType.CSVRegistroDuplicado_Specified(Index: Integer): boolean;
begin
  Result := FCSVRegistroDuplicado_Specified;
end;

procedure RespuestaExpedidaType.SetEstadoRegistroDuplicado(Index: Integer; const AEstadoRegistroSFType: EstadoRegistroSFType);
begin
  FEstadoRegistroDuplicado := AEstadoRegistroSFType;
  FEstadoRegistroDuplicado_Specified := True;
end;

function RespuestaExpedidaType.EstadoRegistroDuplicado_Specified(Index: Integer): boolean;
begin
  Result := FEstadoRegistroDuplicado_Specified;
end;
...
destructor SistemaFacturacionFact.Destroy;
begin
  System.SysUtils.FreeAndNil(FCabecera);
  inherited Destroy;
end;
...
procedure Cabecera.SetRemisionVoluntaria(Index: Integer; const ARemisionVoluntaria: RemisionVoluntaria);
begin
  FRemisionVoluntaria := ARemisionVoluntaria;
  FRemisionVoluntaria_Specified := True;
end;

function Cabecera.RemisionVoluntaria_Specified(Index: Integer): boolean;
begin
  Result := FRemisionVoluntaria_Specified;
end;

procedure Cabecera.SetRemisionRequerimiento(Index: Integer; const ARemisionRequerimiento: RemisionRequerimiento);
begin
  FRemisionRequerimiento := ARemisionRequerimiento;
  FRemisionRequerimiento_Specified := True;
end;

function Cabecera.RemisionRequerimiento_Specified(Index: Integer): boolean;
begin
...
procedure SistemaInformaticoType.SetNombreSistemaInformatico(Index: Integer; const ATextMax30Type: TextMax30Type);
begin
  FNombreSistemaInformatico := ATextMax30Type;
  FNombreSistemaInformatico_Specified := True;
end;

function SistemaInformaticoType.NombreSistemaInformatico_Specified(Index: Integer): boolean;
begin
  Result := FNombreSistemaInformatico_Specified;
end;

procedure SistemaInformaticoType.SetTipoUsoPosibleSoloVerifactu(Index: Integer; const ASiNoType: SiNoType);
begin
  FTipoUsoPosibleSoloVerifactu := ASiNoType;
  FTipoUsoPosibleSoloVerifactu_Specified := True;
end;

function SistemaInformaticoType.TipoUsoPosibleSoloVerifactu_Specified(Index: Integer): boolean;
begin
  Result := FTipoUsoPosibleSoloVerifactu_Specified;
end;

procedure SistemaInformaticoType.SetTipoUsoPosibleMultiOT(Index: Integer; const ASiNoType: SiNoType);
begin
  FTipoUsoPosibleMultiOT := ASiNoType;
  FTipoUsoPosibleMultiOT_Specified := True;
end;

function SistemaInformaticoType.TipoUsoPosibleMultiOT_Specified(Index: Integer): boolean;
begin
  Result := FTipoUsoPosibleMultiOT_Specified;
end;

procedure SistemaInformaticoType.SetNumeroOTAlta(Index: Integer; const ANumerico4Type: Numerico4Type);
begin
  FNumeroOTAlta := ANumerico4Type;
  FNumeroOTAlta_Specified := True;
end;

function SistemaInformaticoType.NumeroOTAlta_Specified(Index: Integer): boolean;
begin
  Result := FNumeroOTAlta_Specified;
end;

procedure RemisionRequerimiento.SetRefRequerimiento(Index: Integer; const Afecha: fecha);
begin
  FRefRequerimiento := Afecha;
  FRefRequerimiento_Specified := True;
end;

function RemisionRequerimiento.RefRequerimiento_Specified(Index: Integer): boolean;
begin
  Result := FRefRequerimiento_Specified;
end;
...
procedure RegistroFacturacionAltaType.SetIdAcuerdoSistemaInformatico(Index: Integer; const ATextMax15Type: TextMax15Type);
begin
  FIdAcuerdoSistemaInformatico := ATextMax15Type;
...
initialization
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(Numerico4Type), 'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd', 'Numerico4Type');
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(ErrorDetalleType), 'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/RespuestaSuministro.xsd', 'ErrorDetalleType');
  ...
  RemClassRegistry.RegisterXSClass(SistemaFacturacionFact, 'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd', 'SistemaFacturacionFact');
  ...
  RemClassRegistry.RegisterXSClass(Cabecera, 'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd', 'Cabecera');
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(Timestamp), 'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd', 'Timestamp');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(RegistroFacturacionAltaType), 'FacturasSustituidas', '[ArrayItemName="IDFacturasSustituida"]');
